...
var makeImage = '<img class="card-img-bottom" src="'+src+'" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Waiting for image loading">'
...
var makeCard = '<div class="card mb-4 shadow-sm">'+makeLightBox+makeBody+'</div>'
